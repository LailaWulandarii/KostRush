                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-8">
                                ...
                                <div class="input-group input-group-merge">
                                    <span id="name" class="input-group-text"><i class="bx bx-bed"></i></span>
                                    <input type="text" class="form-control" id="nama_kamar" name="nama_kamar" aria-describedby="basic-icon-default-fullname2" value="{{ old('nama_kamar', $kamar->nama_kamar) }}" />
                                </div>
                                @error('nama_kamar')
                                    <small>{{ $message }}</small>
                                @enderror
                            ...
                            <div class="col-md">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <div class="form-check">
                                            <input name="status_kamar" class="form-check-input" type="radio" value="kosong" id="statusKosong" {{ old('status_kamar', $kamar->status_kamar) === 'kosong' ? 'checked' : '' }} />
                                            <label class="form-check-label" for="statusKosong">Kosong</label>
                                        </div>
                                    </div>
                                    <div class="col">
                                        <div class="form-check">
                                            <input name="status_kamar" class="form-check-input" type="radio" value="terisi" id="statusTerisi" {{ old('status_kamar', $kamar->status_kamar) === 'terisi' ? 'checked' : '' }} />
                                            <label class="form-check-label" for="statusTerisi">Terisi</label>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="input-group input-group-merge">
                                    <span class="input-group-text"><i class="bx bx-wallet"></i></span>
                                    <input type="number" class="form-control" id="harga" name="harga" value="{{ old('harga', $kamar->harga) }}" />
                                </div>
                                @error('harga')
                                    <small>{{ $message }}</small>
                                @enderror
