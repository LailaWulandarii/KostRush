                      ...
                      <g id="g-app-brand" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                        ...
                        <form id="formAuthentication" class="mb-3" action="{{ 'login_proses' }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="email" name="email" placeholder="Masukkan emailmu" autofocus />
                            </div>
                            @error('email')
                            <small>{{ $message }}</small>
                            @enderror
                            <div class="mb-3 form-password-toggle">
                                ...
                                <div class="input-group input-group-merge">
                                    <input type="password" id="password" class="form-control" name="password" placeholder="Masukkan kata sandimu" aria-describedby="password" />
